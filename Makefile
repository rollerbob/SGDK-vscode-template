...
# User variables
MARSDEV = ${HOME}/workspace/gendev/mars
WINEPREFIX = ${MARSDEV}/wine
EMULPATH = ${WINEPREFIX}/drive_c/gens
EMUL = gens.exe
...
run: debug
	cp -f out.bin ${EMULPATH}/out.elf
	WINEPREFIX=${WINEPREFIX} wine ${EMULPATH}/${EMUL} out.elf